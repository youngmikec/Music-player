$("document").ready(function(){
    ...
    const background = () =>{
        ...
        thumbnail.parentNode.style.backgroundRepeat = "no-repeat";
        thumbnail.parentNode.style.backgroundSize = "cover";
    ...
    //     $('#menu-list').css({
    //         "display": "block",
    //         "background": 'rgba(47, 44, 223, 0.74)',
    //         "color": "white",
    //         "position": "relative",
    //         'top': "40px"
    //     });
